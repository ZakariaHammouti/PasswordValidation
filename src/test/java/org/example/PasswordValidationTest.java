...
class PasswordValidationTest {
    ...
    void analyseReason_ShouldReturnTwoReasons() {
        String[] expectedList = new String[]{"Has not minimal length", "contains invalid char", null, null, null, null, null};
        assertArrayEquals(expectedList, PasswordValidation.analyseReason("sd A/1"));
    }

    @Test
    void analyseReason_ShouldReturnOneReason() {
        String[] expectedList = new String[]{"Has not minimal length", null, null, null, null, null, null};

...
class PasswordValidationTest {
    ...
    @ValueSource(strings = {"", "dd", "%%dsdsd", ";;;;," +
            "zedfgwefzgwef&&&%HHG1111edfgwefzgwef&&&%HHG1111" +
            "edfgwefzgwef&&&%HHG1111edfgwefzgwef&&&%HHG1111edfgwefzgwef&&&%HHG1111"})
    ...
    void analyseReason_ShouldReturnTwoReasons() {
        String[] expectedList = new String[]{"Has not minimal length or too much characters", "contains invalid char", null, null, null, null, null};
        assertArrayEquals(expectedList, PasswordValidation.analyseReason("sd A/1"));
    }

    @Test
    void analyseReason_ShouldReturnOneReason() {
        String[] expectedList = new String[]{"Has not minimal length " +
                "or too much characters", null, null, null, null, null, null};
    ...
    void showReason_ShouldNotThrowException() {
        PasswordValidation.listReason = new String[]{null, null, "Has not minimal length " +
                "or too much characters", null};
